...
[x] Compre os direitos de uso em sites especializados e use quantas vezes quiser. (Nota: Muitas licenças pagas possuem restrições de uso específico ou volume).
...
10. Para configurar uma imagem como ícone de favoritos de uma página (favicon), usamos a tag _____ dentro da área ________ do seu site. Qual dos itens a seguir preenche corretamente as lacunas?
