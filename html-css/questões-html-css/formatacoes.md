# 1. A versão anterior da linguagem, a HTML4 era bastante focada no(a) _____ do conteúdo. Já a versão HTML5 já fica mais voltada para o(a) _____ da estrutura desse conteúdo.
...
- a tag `<big>` deixou de existir e a tag `<small>` segue funcionando  X
...
# 8. Para criar um texto sobrescrito (como em x²) usamos a tag _____ e para criar um texto subscrito (como em H₂O), usamos a tag ______.
